  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yuangong'"  label='擅长' prop="yuangongShanchang">
               <el-input v-model="ruleForm.yuangongShanchang"  placeholder='擅长' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="24">
             <el-form-item v-if="flag=='yuangong'"  label="员工介绍" prop="yuangongContent">
                 <editor
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.yuangongShanchang)&& 'yuangong'==this.flag){
                         ...
                         if((!this.ruleForm.yuangongContent)&& 'yuangong'==this.flag){
                             this.$message.error('员工介绍不能为空');
                             return
                         }
