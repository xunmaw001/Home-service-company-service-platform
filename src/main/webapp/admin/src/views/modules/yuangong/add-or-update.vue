    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="擅长" prop="yuangongShanchang">
                       <el-input v-model="ruleForm.yuangongShanchang"
                                 placeholder="擅长" clearable  :readonly="ro.yuangongShanchang"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="擅长" prop="yuangongShanchang">
                           <el-input v-model="ruleForm.yuangongShanchang"
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="员工介绍" prop="yuangongContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.yuangongContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.yuangongContent" label="员工介绍" prop="yuangongContent">
                            <span v-html="ruleForm.yuangongContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    yuangongPhone: false,
                    yuangongPhoto: false,
                    yuangongShanchang: false,
                    sexTypes: false,
                    yuangongEmail: false,
                    yuangongContent: false,
                },
                ruleForm: {
                    username: '',
                    password: '',
                ...
                rules: {
                   ...
                   yuangongContent: [
                              { required: true, message: '员工介绍不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
