...
public class JiazhengfuwuLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public JiazhengfuwuLiuyanEntity() {

	}

	public JiazhengfuwuLiuyanEntity(T t) {
		try {
     ...
     * 留言内容
     */
    @TableField(value = "jiazhengfuwu_liuyan_text")
    ...
    public String toString() {
        return "JiazhengfuwuLiuyan{" +
            "id=" + id +
            ", jiazhengfuwuId=" + jiazhengfuwuId +
            ", yonghuId=" + yonghuId +
            ", jiazhengfuwuLiuyanText=" + jiazhengfuwuLiuyanText +
