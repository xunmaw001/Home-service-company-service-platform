...
public class JiazhengfuwuLiuyanView extends JiazhengfuwuLiuyanEntity implements Serializable {
	...
	public JiazhengfuwuLiuyanView() {

	}

	public JiazhengfuwuLiuyanView(JiazhengfuwuLiuyanEntity jiazhengfuwuLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, jiazhengfuwuLiuyanEntity);
