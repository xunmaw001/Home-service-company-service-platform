...
public class JiazhengfuwuCommentbackView extends JiazhengfuwuCommentbackEntity implements Serializable {
	...
	public JiazhengfuwuCommentbackView() {

	}

	public JiazhengfuwuCommentbackView(JiazhengfuwuCommentbackEntity jiazhengfuwuCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, jiazhengfuwuCommentbackEntity);
